...
import { formatDateV2 } from "../../../../utils/helpers";
...
function Header(props) {
  ...
  const onSubmit = async (e) => {
    ...
    if (
      ...
      message.warning("You have not entered enough information!");
    } else {
      if (img) {
        ...
        const anh = await storage
          ...
          .child(img.name)
          .getDownloadURL();
        var updateUser = await taikhoanApi
          .edituser({
            idsua: idsua,
            name: name,
            avatar: anh,
        ...
        var updateUserRole = await userroleApi
          .edituserroleHeader({
            idsua: user.idUserRole,
            kynang: kynang,
            chamngon: chamngon,
            website: website,
            github: github,
        ...
        console.log(updateUser, updateUserRole);
        ...
        >
          <div>
            ...
            <div className="row">
              <div className="col-md-6">
                ...
                <p className="mb-2">
                  <span>Company:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                  <span className="tt-user">Danang Tourism</span>
                </p>
                <p className="mb-2">
                  <span>Birthday:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                  <span className="tt-user">{formatDateV2(user.ngaysinh)}</span>
                </p>
              </div>
              <div className="col-md-6">
                <p className="mb-2">
                ...
                <p className="mb-2">
                  <span>Website:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                  <span className="tt-user">travel.com.vn</span>
                </p>
              </div>
              <p className="tab">
                <span>Maxim:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <span className="tt-user">{user.chamngon}</span>
              </p>
            </div>
          </div>
          <hr />
          ...
          <div className="row">
            <div className="col-md-6">
              <p className="mb-2">
                <span>Position:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <span className="tt-user">Manager</span>
              </p>
              <p className="mb-2">
                <span>Department:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <span className="tt-user">{users ? users.role : ""}</span>
              </p>
            </div>
            <div className="col-md-6">
              <p className="mb-2">
                <span>Responsibility:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <span className="tt-user">{users ? users.mota : ""}</span>
              </p>
              <p className="mb-2">
                <span>Monitor:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <span className="tt-user">Admin</span>
              </p>
            </div>
            <p className="tab">
              <span>Skill:&nbsp;&nbsp;&nbsp;&nbsp;</span>
              <span className="tt-user text-justify">{user.kynang}</span>
            </p>
          </div>
          <hr />
          <h4>Contact</h4>
          <div className="row">
            <div className="col-md-6">
              ...
              <p className="mb-2">
                <span>Github:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <span className="tt-user">{user.github}</span>
              </p>
            </div>
            <div className="col-md-6">
              <p className="mb-2">
              ...
              <p className="mb-2">
                <span>Facebook:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <span className="tt-user">{user.facebook}</span>
              </p>
            </div>
          </div>
          <Button
      ...
      >
        <form action="" method="post" onSubmit={onSubmit}>
          ...
          <div className="form-group">
            ...
            <select className="form-control" onChange={handleGender}>
