                ...
                >
                    <div>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <p className="mb-2"><span>Công ty:&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="tt-user">Du lịch Đà Nẵng</span></p>
                            ...
                            <div className="col-md-6">
                                ...
                                <p className="mb-2"><span>Website:&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="tt-user">travel.com.vn</span></p>
                            </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <p className="mb-2"><span>Giám sát:&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="tt-user">Admin</span></p>
                        </div>
