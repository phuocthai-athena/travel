...
import logo from "./../../../images/V&3T-logo-1.png";
import { Button, IconButton } from "@material-ui/core";
import { storage } from "../../../../firebase";
import { infoData } from "../../login/infoSlice";
...
function ListMenu(props) {
  ...
  const ss = (
    <Menu>
      <Menu.Item key="0">
        <Linkrt to="/login">Login</Linkrt>
      </Menu.Item>
      <Menu.Item key="2">
        <span onClick={showDrawer}>View information</span>
      </Menu.Item>
      <Menu.Item key="4">
        <Linkrt to="/thongtin/0">View history</Linkrt>
      </Menu.Item>
      {users ? (
        phanquyen() ? (
          <Menu.Item key="3">
  ...
  return (
    <div id="menu">
      <nav className="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
        <Linkrt className="navbar-brand size" to="/">
          <img src={logo} alt="" />
        </Linkrt>
        <button
                ...
                <div className="col-md-12">
                  ...
                  <p className="mb-2">
                    ...
                    <span className="tt-user">
                      {user.gioitinh === +1 ? "Male" : "Female"}
                    </span>
                  </p>
                  <p className="mb-2">
                    <span>Birthday:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    <span className="tt-user">
                      {formatDateV2(user.ngaysinh)}
                    </span>
                  </p>
                </div>
