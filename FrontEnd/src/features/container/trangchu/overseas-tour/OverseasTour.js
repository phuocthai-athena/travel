...
function OverseasTour(props) {
  ...
  const getPoint = (id) => {
    ...
    let point = Math.round((sumPoint / +commentList.length) * 10) / 10;
    if (isNaN(point)) {
      point = 0;
    }
    return point;
  ...
  return (
    <div className="mt-5 mb-5 tour" id="tour">
      <SectionTitle
        title="Overseas tour"
        description="Traveling abroad gives people a new perspective on another country and
          a better understanding of other countries."
      />
...
OverseasTour.propTypes = {};

export default OverseasTour;
